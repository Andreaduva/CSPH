...
// Using different initial conditions and parameters with respect to version 1 of
// the same problem
// =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    std::string out_dir = GetChronoOutputPath() + "shock_tube_1D_v2";
    ...
    sysSPH.SetADKECoeff(0.4, 0.4, kern_multip);
    ...
    sysSPH.SetArtificialHeatingCoefficient(0.02, 0.04);
